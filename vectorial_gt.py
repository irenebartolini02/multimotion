...
if __name__ == '__main__':
    extract_vectorial_gt("survey_data/SurveyDataJuly24/exp-2025-06-08-with-lopo/merged_data.xlsx",
                         "survey_data/SurveyDataJuly24/exp-2025-06-08-with-lopo/vectorial/individual_ground_truth.csv",
                         ["F3YZw", "VGCNk", "3hxsz", "EMX7o", "iHMUL", "SaqCY", "hit94", "pV9tu", "4AxqV", "agWdu", "CAJBM", "CEMKM", "RYXuu", "6CCj", "8C6iE", "cdVZZ", "dDLFD", "dU5uF", "er6ZP", "fA8yJ", "FS48s", "jJUMU", "KSPEO", "twq7m", "uu9cj", "VksBp", "hMHEK2", "KfBii", "2LBuk", "8DhRbY", "WaWrWi", "Yfg4l", "SbBNV", "A5TLF", "Oa4hap", "9FGka", "Fk2oP", "22DFx", "Lks24r", "L3OT", "5BJD3", "uksXB", "EJOiBs", "oJxBj", "VBss6", "Cjddt", "Lh5dT", "L2Lzw", "L2Lzw_2", "L9TG7", "Fg2ghyT", "FmN3", "FDsxx", "SDJkl1"],
